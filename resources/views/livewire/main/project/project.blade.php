<div class="w-full" x-data="window.LVoePqYZdmjQURo">

    {{-- Breadcrumbs --}}
    <nav class="justify-between px-4 py-3 text-gray-700 rounded-lg sm:flex sm:px-5 bg-white dark:bg-gray-800 dark:border-gray-700 shadow" aria-label="Breadcrumb">
        ...
        <ol class="inline-flex items-center mb-3 space-x-1 md:space-x-3 rtl:space-x-reverse sm:mb-0">
            ...
            <li>
                <div class="flex items-center">
                    <a href="{{ url('/') }}" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-700 hover:text-primary-600 ltr:md:ml-2 rtl:md:mr-2 dark:text-gray-400 dark:hover:text-white">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    {{-- Right chevron --}}
                    <svg aria-hidden="true" class="hidden ltr:block w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>

                    {{-- Left chevron --}}
                    <svg xmlns="http://www.w3.org/2000/svg" class="hidden rtl:block w-5 h-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor"> <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd"/> </svg>

                    <a href="{{ url('explore/projects') }}" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-700 hover:text-primary-600 ltr:md:ml-2 rtl:md:mr-2 dark:text-gray-400 dark:hover:text-white">
        ...
        <div>
            ...
            <div id="project-page-actions" class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700">
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="project-page-actions-default">
					...
					@auth
						@if (auth()->id() != $project->user_id)
							<li>
								<button type="button" id="modal-report-project-button" class="w-full flex items-center space-x-3 rtl:space-x-reverse px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white focus:outline-none focus:ring-transparent">
									<svg class="w-5 h-5 text-gray-500" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 6a3 3 0 013-3h10a1 1 0 01.8 1.6L14.25 8l2.55 3.4A1 1 0 0116 13H6a1 1 0 00-1 1v3a1 1 0 11-2 0V6z" clip-rule="evenodd"></path></svg>
                    ...
                    {{-- Share project --}}
                    <li>
                        <button type="button" id="modal-share-project-button" class="w-full flex items-center space-x-3 rtl:space-x-reverse px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white focus:outline-none focus:ring-transparent">
							<svg class="w-5 h-5 text-gray-500" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M15 8a3 3 0 10-2.977-2.63l-4.94 2.47a3 3 0 100 4.319l4.94 2.47a3 3 0 10.895-1.789l-4.94-2.47a3.027 3.027 0 000-.74l4.94-2.47C13.456 7.68 14.19 8 15 8z"></path></svg>
    ...
    <div class="py-10">
        ...
        <div class="gap-6 grid grid-cols-1 lg:grid-cols-3 lg:grid-flow-col-dense mt-8">
          <div class="space-y-10 lg:col-start-1 lg:col-span-2">
            ...
            <section class="w-full">
                <div class="bg-white shadow rounded-lg">
                    ...
                    {{-- Section heading --}}
                    <div class="px-4 py-5 sm:px-6 w-full rounded-t-lg sm:flex sm:items-center sm:justify-between">
						<div>
							<h2 class="text-base font-semibold text-zinc-900">
								@lang('messages.t_project_details')
							</h2>
							<p class="mt-1 max-w-2xl text-sm text-gray-500 font-normal">
								@lang('messages.t_project_details_subtitle')
							</p>
						</div>
						...
						@auth
							@if (auth()->id() != $project->user_id && $project->status === 'active')
								<button id="modal-bid-button" type="button" class="inline-flex justify-center items-center rounded-md border font-medium tracking-wider focus:outline-none px-8 py-3 leading-5 text-[13px] border-primary-600 bg-primary-600 text-white hover:text-white hover:bg-primary-700 hover:border-primary-700 focus:ring focus:ring-primary-500 focus:ring-opacity-50 active:bg-primary-600 active:border-primary-600">
                    ...
                    {{-- Section body --}}
                    <div class="border-t border-gray-100 px-4 py-5 sm:px-6 pb-8">

                        {{-- Description --}}
                        <h2 class="mb-4 font-bold text-zinc-600 text-sm">
                            {{ __('messages.t_description') }}
                        </h2>  
                        <div class="text-base font-normal leading-relaxed text-zinc-500 mb-12 block">
                        ...
                        <div class="mb-12 block">
							<div class="flex items-center space-x-4">
								<img class="w-9 h-9 rounded-full lazy object-cover" src="{{ placeholder_img() }}" data-src="{{ src($project->client->avatar) }}" alt="{{ $project->title }}">
								<div class="font-medium text-zinc-800 dark:text-white">
									<div class="text-[13px]">{{ $this->clientUsername() }}</div>
                        ...
                        {{-- Required skills --}}
                        <div>
                            <h2 class="mb-4 font-bold text-zinc-600 text-sm">@lang('messages.t_required_skills')</h2>  
                            @foreach ($project->skills as $skill)
                                <a class="bg-gray-100 hover:bg-primary-100 text-gray-800 hover:text-primary-600 text-xs font-medium ltr:mr-2 rtl:ml-2 ltr:first:mr-0 rtl:first:ml-0 px-2.5 py-1 rounded dark:bg-gray-700 dark:text-gray-400 border border-gray-500 hover:border-primary-600 transition-colors duration-200" href="{{ url('projects/categories/' . $project->category->slug . '/' . $skill->skill->slug) }}">
                                    {{ $skill->skill->name }}
                                </a>   
                            @endforeach                              
                        </div>
                        ...
                        @if ($project->status === 'active')
                            <div class="rounded-md bg-yellow-50 p-4 mt-10">
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <h3 class="text-sm font-medium text-yellow-800">{{ __('messages.t_beware_of_scams') }}</h3>
            ...
            <section aria-labelledby="timeline-title" class="lg:col-start-3 lg:col-span-1">
                ...
                {{-- Summary --}}
                <div class="overflow-hidden bg-white shadow rounded-lg mb-6">
                    ...
                    <div class="px-4 py-5 sm:px-6">
                        ...
                        <p class="mt-1 max-w-2xl text-sm text-gray-500 font-normal">
                            @lang('messages.t_project_summary_subtitle')
                        </p>
                    </div>
                    ...
                    <div class="border-t border-gray-200">
                        <dl>
                            ...
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">@lang('messages.t_budget')</dt>
                                <dd class="mt-1 text-sm text-zinc-900 sm:col-span-2 sm:mt-0 font-semibold">
							...
							<div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">@lang('messages.t_budget_type')</dt>
                                <dd class="mt-1 text-sm text-zinc-900 sm:col-span-2 sm:mt-0 font-semibold">
                            ...
                            {{-- Duration --}}
							<div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">@lang('messages.t_duration')</dt>
                                <dd class="mt-1 text-sm text-zinc-900 sm:col-span-2 sm:mt-0 font-semibold">
                                    @if ($project->duration === 1)
										{{ $project->duration }} {{ strtolower(__('messages.t_day')) }}
									@else
										{{ $project->duration }} {{ strtolower(__('messages.t_days')) }}
									@endif

									{{-- Urgent project --}}
									@if ($project->is_urgent)
										<span class="text-red-500 ltr:pl-2 rtl:pr-2">@lang('messages.t_urgent_project')</span>
									@endif
                                </dd>
                            </div>
							...
							{{-- Total bids --}}
							<div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								<dt class="text-sm font-medium text-gray-500">@lang('messages.t_bids')</dt>
							...
							{{-- Avg bid --}}
							<div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								<dt class="text-sm font-medium text-gray-500">@lang('messages.t_avg_bid')</dt>
								<dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
							...
							{{-- Status --}}
							<div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								<dt class="text-sm font-medium text-gray-500">@lang('messages.t_status')</dt>
								<dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
									...
									@switch($project->status)
										...
										{{-- Active --}}
										@case('active')
											<span class="bg-emerald-50 text-emerald-600 h-11 px-8 py-2 rounded-md font-semibold text-xs">
										...
										@case('pending_approval')
											<span class="bg-amber-50 text-amber-600 h-11 px-8 py-2 rounded-md font-semibold text-xs">
										...
										{{-- Completed --}}
										@case('completed')
											<span class="bg-green-50 text-green-600 h-11 px-8 py-2 rounded-md font-semibold text-xs">
										...
										{{-- Hidden --}}
										@case('hidden')
											<span class="bg-gray-50 text-gray-600 h-11 px-8 py-2 rounded-md font-semibold text-xs">
										...
										{{-- Rejected --}}
										@case('rejected')
											<span class="bg-red-50 text-red-600 h-11 px-8 py-2 rounded-md font-semibold text-xs">
										...
										@case('under_development')
											<span class="bg-blue-50 text-blue-600 h-11 px-8 py-2 rounded-md font-semibold text-xs">
										...
										@case('pending_final_review')
											<span class="bg-fuchsia-50 text-fuchsia-600 h-11 px-8 py-2 rounded-md font-semibold text-xs">
										...
										{{-- Incomplete --}}
										@case('incomplete')
											<span class="bg-stone-50 text-stone-600 h-11 px-8 py-2 rounded-md font-semibold text-xs">
										...
										{{-- Closed --}}
										@case('closed')
											<span class="bg-rose-50 text-rose-600 h-11 px-8 py-2 rounded-md font-semibold text-xs">
							...
							{{-- Clicks --}}
							<div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								<dt class="text-sm font-medium text-gray-500">@lang('messages.t_clicks')</dt>
								<dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
							...
							{{-- Impressions --}}
							<div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								<dt class="text-sm font-medium text-gray-500">@lang('messages.t_impressions')</dt>
								<dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
							...
							{{-- Created date --}}
							<div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								<dt class="text-sm font-medium text-gray-500">@lang('messages.t_posted_date')</dt>
								<dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
				...
				<x-slot name="content">
					...
					@if (settings('projects')->is_premium_bidding && $bid_current_step === 2)
						<fieldset>
							...
							{{-- Section title --}}
							<legend class="mb-4">@lang('messages.t_optional_upgrades')</legend>
		
							<div class="space-y-2 divide-y divide-gray-200 w-full">
								@foreach ($plans as $plan)
									<div class="relative flex items-center w-full py-4">
										<div class="flex items-center h-5">
											<input id="bid-promotion-plan-{{ $plan->uid }}" name="bidding_selected_plans" wire:model.defer="bid_{{ $plan->plan_type }}" value="{{ $plan->uid }}" type="checkbox" class="focus:ring-transparent focus:outline-none ring-offset-0 focus:shadow-none h-5 w-5 text-primary-600 border-gray-300 border-2 rounded-sm cursor-pointer">
										</div>
										<div class="ltr:ml-4 rtl:mr-4 text-sm w-full">
											<label for="bid-promotion-plan-{{ $plan->uid }}" class="font-medium text-gray-700 flex items-center justify-between">
												...
												{{-- Price --}}
												<span class="text-sm font-semibold text-zinc-700 bg-gray-100 rounded-md px-3 py-2">@money($plan->price, settings('currency')->code, true)</span>
						...
						<div>
							@if ($bid_current_step === 2)
								<button 
									...
									class="text-[13px] font-semibold flex justify-center bg-white hover:bg-gray-100 text-gray-800 py-4 px-8 rounded tracking-wide focus:outline-none focus:shadow-outline cursor-pointer border border-gray-300 shadow-sm">
