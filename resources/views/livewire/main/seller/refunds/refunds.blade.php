                                    ...
                                    @forelse ($refunds as $refund)                                        
                                        <tr wire:key="seller-refunds-id-{{ $refund->uid }}">
                                            ...
                                            <td class="whitespace-nowrap py-4 ltr:pl-10 rtl:pr-10 ltr:pr-3 rtl:pl-3 text-sm font-medium text-gray-900 sm:ltr:pl-10 sm:rtl:pr-10">
                                                <div class="flex items-center">
                                                    <div class="h-10 w-10 flex-shrink-0">
                                                        <img class="h-10 w-10 rounded-full lazy" src="{{ placeholder_img() }}" data-src="{{ src($refund->item->gig->thumbnail) }}" alt="{{ $refund->item->gig->title }}">
                                                    </div>
                                            ...
                                            <td class="whitespace-nowrap py-4 ltr:pl-10 rtl:pr-10 ltr:pr-3 rtl:pl-3 text-sm font-medium text-gray-900 sm:ltr:pl-10 sm:rtl:pr-10">
                                                <div class="flex items-center">
                                                    <div class="h-10 w-10 flex-shrink-0">
                                                        <img class="h-10 w-10 rounded-full lazy" src="{{ placeholder_img() }}" data-src="{{ src($refund->buyer->avatar) }}" alt="{{ $refund->buyer->username }}">
                                                    </div>
                                                    <div class="ltr:ml-4 rtl:mr-4">
