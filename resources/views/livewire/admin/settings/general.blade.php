        ...
        <div class="py-10 px-12">
            ...
            <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                ...
                <div class="col-span-12 md:col-span-4">
                    <x-forms.file-input :label="__('messages.t_site_logo')" model="logo" accept="image/jpg,image/jpeg,image/png,image/svg+xml"  />
                    {{-- Preview image --}}
                ...
                {{-- Site Logo dark mode --}}
                <div class="col-span-12 md:col-span-4">
                    <x-forms.file-input :label="__('messages.t_site_logo_dark_mode')" model="logo_dark" accept="image/jpg,image/jpeg,image/png,image/svg+xml"  />
                    {{-- Preview image --}}
