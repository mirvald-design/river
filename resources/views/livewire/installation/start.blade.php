            ...
            <div class="bg-white shadow rounded-lg mb-6">
                ...
                <div class="w-full mb-8 px-10 pb-8">
                    ...
                    <div class="rounded-md bg-red-50 p-4 !mt-8">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-red-800">NULLED raz0r / nullcave.club. Spread:<a style="color:red;" href="https://conff.org/?from=nulled-riverr" target="_blank">CONFF.ORG</a></h3>
                        </div>
                        </div>
                    </div>
