        ...
        <div class="w-full relative">
            ...
            <div class="bg-white rounded-md mt-4 shadow px-12 py-8 mb-8">
                <div class="grid grid-cols-12 gap-y-8 gap-x-5">
                    ...
                    <div class="col-span-12">
                        <h3 class="mt-2 text-base font-semibold tracking-wide text-gray-800" v-text="__('t_budget')"></h3>
                        <p class="mt-1 text-sm text-gray-500" v-text="__('t_how_do_u_want_to_pay')"></p>
                    </div>

                    <!-- How do you want to pay -->
                    <div class="col-span-12" id="section-budget"> 
                        <div class="relative w-full rounded-lg h-12 bg-gray-100">

                            <div class="relative w-full h-full flex items-center px-2">

                                <!-- Fixed price -->
                                <div @click="form.salary_type = 'fixed'" class="w-full h-full flex justify-center text-gray-400 cursor-pointer text-[13px] font-medium tracking-wide">
                                    <button class="w-full h-full focus:outline-none" v-text="__('t_fixed_price')"></button>
                                </div>

                                <!-- Hourly price -->
                                <div @click="form.salary_type = 'hourly'" class="w-full h-full flex justify-center text-gray-400 cursor-pointer text-[13px] font-medium tracking-wide">
                            ...
                            class="bg-white shadow text-[13px] font-semibold flex items-center justify-center w-1/2 rounded transition-all duration-150 ease-linear absolute h-10 top-1 text-gray-600 pt-px"></span>
                    ...
                    <div class="col-span-12 md:col-span-6">
                        ...
                        <div class="relative rounded-md shadow-sm flex">
                            ...
                            <!-- Label -->
                            <span class="inline-flex items-center px-3 ltr:rounded-l-md rtl:rounded-r-md border ltr:border-r-0 rtl:border-l-0 border-gray-300 bg-gray-50 text-gray-500 text-sm" v-text="__('t_max')"></span>
            ...
            <!-- Promotion section -->
            <div class="bg-white rounded-md mt-4 shadow px-12 py-8 mb-8" id="section-premium" v-if="settings.is_premium">

                <!-- Section heading -->
                <div class="w-full mb-10">
                    <h3 class="mt-2 text-base font-semibold tracking-wide text-gray-800" v-text="__('t_promotion')"></h3>
                    <p class="mt-1 text-sm text-gray-500" v-text="__('t_make_ur_project_premium')"></p>
                </div>
                ...
                <div class="grid grid-cols-1 md:gap-x-5 gap-y-6">
                    <template v-for="(plan, index) in JSON.parse(plans)" :key="`plan-${ index }`">
                        ...
                        <div :class="hasPlan(plan.id) ? 'border-primary-600 ring-1 ring-primary-600' : ''" class="mb-2 rounded-lg px-4 py-4 border shadow-sm bg-white"><div class="card-body"><div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4"><div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="flex items-center mb-3 space-x-3 rtl:space-x-reverse">
                                    ...
                                    <!-- Price -->
                                    <div class="text-sm font-extrabold text-zinc-800" v-text="$money(plan.price, currency)"></div>
                                ...
                                <!-- Description -->
                                <div class="text-[13px] font-normal leading-6 text-gray-500 tracking-wide" v-text="plan.description"></div>
                        ...
                        <div class="flex">
                            ...
                            :class="hasPlan(plan.id) ? 'bg-primary-600 text-white border-primary-600' : 'bg-white hover:bg-gray-50 text-gray-600 active:bg-gray-100 border-gray-300'" 
            ...
            <!-- Total -->
            <div class="flex items-center space-x-3 rtl:space-x-reverse bg-gray-100 hover:bg-gray-200 hover:bg-opacity-50 p-4 rounded-xl mb-8" v-if="settings.is_premium">
                <div class="grow">
                    <p class="text-sm text-gray-600 font-medium" v-text="__('t_total')"></p>
                </div>
                <div class="flex-none ltr:text-right rtl:text-left text-zinc-900 font-black text-base" v-text="$money(total, currency)"></div>
            </div>
        ...
        methods: {
            ...
            select2() {
                ...
                $('#select2-categories').select2({
                    ...
                    selectionCssClass      : `block w-full ltr:pr-10 ltr:pl-4 rtl:pl-10 rtl:pr-4 placeholder:font-normal placeholder:text-[13px] text-sm font-medium text-zinc-800 !rounded-md ${ this.hasError('category') ? 'focus:!ring-red-600 focus:!border-red-600 !border-red-500' : 'focus:!ring-primary-600 focus:!border-primary-600 !border-gray-300' }`,
                    width                  : '100%',
                ...
                $('#select2-skills').select2({
                    ...
                    selectionCssClass      : `select2-skills block w-full ltr:pr-10 ltr:pl-4 rtl:pl-10 rtl:!pr-4 placeholder:font-normal placeholder:text-[13px] text-sm font-medium text-zinc-800 !rounded-md ${ this.hasError('skills') ? 'focus:!ring-red-600 focus:!border-red-600 !border-red-500' : 'focus:!ring-primary-600 focus:!border-primary-600 !border-gray-300' }`,
                    width                  : '100%',
                    closeOnSelect          : false,
                    multiple               : true,
