...
class TrashComponent extends Component
{
    ...
    public function confirmRestore($id)
    {
        ...
        $this->dialog()->confirm([
            ...
            'description' => "<div class='leading-relaxed'>" . __('messages.t_are_u_sure_u_want_to_restore_this_user') . "<br><b>". $user->username . "</div>",
            'icon'        => 'error',
            'accept'      => [
    ...
    public function confirmDelete($id)
    {
        ...
        $this->dialog()->confirm([
            ...
            'description' => "<div class='leading-relaxed'>" . __('messages.t_are_u_sure_u_want_to_prmtly_delete_usr') . "<br><b>". $user->username ."</b><br>" . __('messages.t_all_records_related_to_user_will_erased') . "</div>",
            'icon'        => 'error',
            'accept'      => [
