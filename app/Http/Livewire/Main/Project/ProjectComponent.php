...
class ProjectComponent extends Component
{
    ...
    public function next()
    {
        try {
            ...
            if ($this->bid_current_step === 1) {
                ...
                if ($this->bid_amount < $this->project->budget_min || $this->bid_amount > $this->project->budget_max ) {
            ...
            if ($this->bid_current_step === 2) {
                ...
                if (isset($response['redirect'])) {
                    ...
                    // Go to payment url
                    return redirect('account/bids/checkout/' . $response['redirect']);
    ...
    private function bid()
    {
        ...
        // Send his a notification via email
